...
let seperator = /(\d)+\s?(milliseconds|millisecond|ms|seconds|second|secs|sec|s|minutes|minute|mins|min|m|hours|hour|hrs|hr|h|days|day|d|weeks|week|w|years|year|yrs|yr|y)/gi;
